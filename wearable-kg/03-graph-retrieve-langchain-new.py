...
# Structured retriever to get filtered relationships or all information
def structured_retriever(question: str) -> str:
    ...
    # If no relationship is specified, return all related information
...
# print(structured_retriever("How about the app package name Xyz.Klinker.Messenger work?"))
